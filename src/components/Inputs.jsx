  ...
  return (
    <div className='flex flex-row justify-center my-6' >
        ...
        <div className='flex flex-row w-1/4 items-center justify-center'>
            <button name='metric' className='text-white text-xl font-light hover:scale-125' onClick={handleUnitsChange}  > °C </button>
            <p className='text-xl text-white mx-1' > | </p>
            <button name='imperial' className='text-white text-xl font-light hover:scale-125' onClick={handleUnitsChange} > °F </button>
        </div>
    </div>
  )
}
